...
import { type Options, authControllerSignup, authControllerLogin, userControllerGetFullAccess } from '../sdk.gen';
import { queryOptions, type UseMutationOptions } from '@tanstack/react-query';
import type { AuthControllerSignupData, AuthControllerSignupError, AuthControllerSignupResponse, AuthControllerLoginData, AuthControllerLoginError, AuthControllerLoginResponse, UserControllerGetFullAccessData } from '../types.gen';
...
export const userControllerGetFullAccessQueryKey = (options?: Options<UserControllerGetFullAccessData>) => createQueryKey('userControllerGetFullAccess', options);

export const userControllerGetFullAccessOptions = (options?: Options<UserControllerGetFullAccessData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
