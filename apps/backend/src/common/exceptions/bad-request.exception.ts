...
export class BadRequestException extends HttpException {
  ...
  code: number | undefined; // Internal status code
  @ApiHideProperty()
  override cause: Error | undefined; // Error object causing the exception
  @ApiProperty({
    description: 'Message for the exception',
    example: 'Bad Request',
  })
  override message: string; // Message for the exception
  @ApiProperty({
  ...
  generateHttpResponseBody = (
    ...
    return <IHttpBadRequestExceptionResponse>{
      code: this.code,
